...
<head>
    ...
    <title>CBT MATHEMATICS EVENT | {{ $title }}</title>
    <link rel="icon" type="image/x-icon" href="{{ url('/assets/img') }}/logo-ME-XXIV.png" />
...
<body class="sidebar-noneoverflow">
        ...
        <header class="header navbar navbar-expand-sm">
            <ul class="navbar-nav theme-brand flex-row  text-center">
                <li class="nav-item theme-logo">
                    <a href="">
                        <img src="{{ url('/assets/img') }}/logo-ME-XXIV.png" class="navbar-logo" alt="logo">
                    </a>
                </li>
                <li class="nav-item theme-text">
                    <a href="" class="nav-link"> ME XXIV </a>
                </li>
                            ...
                            <div class="media mx-auto">
                                ...
                                @if (session()->get('role') === 2)
                                    ...
                                    <div class="media-body">
                                        ...
                                        <p>ADMIN CBT MATHEMATICS EVENT</p>
                                    </div>
                                    @php
                                ...
                                @if (session()->get('role') === 3)
                                    ...
                                    <div class="media-body">
                                        ...
                                        <p>PESERTA CBT MATHEMATICS EVENT</p>
                                    </div>
                                    @php
    ...
    <script>
        ...
        document.addEventListener('keyup', function(event) {
            if (event.code === 'PrintScreen' || event.code === 'MetaLeft' || event.code === 'MetaRight') {
                hidePage();
            }
        });
