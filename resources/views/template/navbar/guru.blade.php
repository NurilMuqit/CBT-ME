    ...
    <nav id="sidebar">
        <div class="profile-info">
            ...
            <div class="user-info">
                ...
                <p class="">ADMIN CBT-Mathematics Event</p>
            </div>
        </div>
        <div class="shadow-bottom"></div>
        <ul class="list-unstyled menu-categories" id="accordionExample">
            <li class="menu {{ $menu['menu'] == 'dashboard' ? 'active' : '' }}">
                <a href="{{ url('/guru') }}" aria-expanded="{{ $menu['expanded'] == 'dashboard' ? 'true' : 'false' }}"
            ...
            <li class="menu {{ $menu['menu'] == 'bank_soal' ? 'active' : '' }}">
                <a href="{{ url('/guru/bank_soal') }}"
                    aria-expanded="{{ $menu['expanded'] == 'bank_soal' ? 'true' : 'false' }}" class="dropdown-toggle">
                    <div class="">
