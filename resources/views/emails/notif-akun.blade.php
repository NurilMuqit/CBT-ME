...
<body>
    <div style="padding: 10px;">
        ...
        <small style="color: #000;"> CBT MATHEMATICS EVENT| by HIMATIKA</small>
        <p style="font-family: `Segoe UI`, Tahoma, Geneva, Verdana, sans-serif; color: #000;">
            Halo {{ $details['nama'] }}, Admin telah menambahkan kamu kedalam aplikasi CBT MATHEVENT, berikut merupakan informasi akunmu :
        </p>
