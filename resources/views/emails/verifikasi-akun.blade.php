...
<body>
    <div style="padding: 10px;">
        ...
        CBT Mathematics Event
        </div>
        <small style="color: #000;">Mathematics Event | by Himatika</small>
        <p style="font-family: `Segoe UI`, Tahoma, Geneva, Verdana, sans-serif; color: #000;">
            Halo {{ $details['nama'] }}, kamu telah mendaftar kedalam aplikasi CBT Mathematics Event. berikut merupakan informasi akunmu :
        </p>
