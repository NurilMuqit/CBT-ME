                                            ...
                                            <div class="widget p-3 mt-3">
                                                ...
                                                <div class="widget-content mt-3" style="position: relative;">
                                                    ...
                                                    <div class="green-radio color-green">
                                                        <textarea name="{{ $soal->detailessay->id }}" data-alternateName="{{ $soal->detailessay->id }}"
                                                ...
                                                <div class="widget-content mt-3" style="position: relative;">
                                                    ...
                                                    <div class="green-radio color-green">
                                                        <textarea name="{{ $soal->detailessay->id }}" data-alternateName="{{ $soal->detailessay->id }}"
                                                            data-alternateValue="{{ $no }}" id="soal{{ $no }}-{{ $soal->detailessay->id }}"
                                                            data-essay_siswa="{{ $soal->id }}" data-noSoal="{{ $no }}" class="form-control"
                                                            placeholder="Tidak Dijawab..." contenteditable readonly style="background-color: #fff !important">
@if ($soal->jawaban !== null)
{{ $soal->jawaban }}
@endif
</textarea>
