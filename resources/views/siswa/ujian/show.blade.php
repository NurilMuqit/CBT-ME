...
@section('content')
                                                        ...
                                                        <ol type="A" style="color: #000; margin-left: -20px;">
                                                            <li class="answer-number">
                                                                <input type="radio" data-alternatetype="radio"
                                                                    name="{{ $soal->detailujian->id }}"
                                                                    value="{{ substr($soal->detailujian->pg_1, 0, 1) }}"
                                                                    id="soal{{ $no }}-{{ substr($soal->detailujian->pg_1, 0, 1) }}"
                                                                    data-pg_siswa="{{ $soal->id }}"
                                                                    data-noSoal="{{ $no }}" class="answer-radio"
                                                                    @if ($soal->jawaban == substr($soal->detailujian->pg_1, 0, 1)) checked @endif />
                                                                <label
                                                            ...
                                                            <li class="answer-number">
                                                                <input type="radio" data-alternatetype="radio"
                                                                    name="{{ $soal->detailujian->id }}"
                                                                    value="{{ substr($soal->detailujian->pg_2, 0, 1) }}"
                                                                    id="soal{{ $no }}-{{ substr($soal->detailujian->pg_2, 0, 1) }}"
                                                                    data-pg_siswa="{{ $soal->id }}"
                                                                    data-noSoal="{{ $no }}" class="answer-radio"
                                                                    @if ($soal->jawaban == substr($soal->detailujian->pg_2, 0, 1)) checked @endif />
                                                                <label
                                                            ...
                                                            <li class="answer-number">
                                                                <input type="radio" data-alternatetype="radio"
                                                                    name="{{ $soal->detailujian->id }}"
                                                                    value="{{ substr($soal->detailujian->pg_3, 0, 1) }}"
                                                                    id="soal{{ $no }}-{{ substr($soal->detailujian->pg_3, 0, 1) }}"
                                                                    data-pg_siswa="{{ $soal->id }}"
                                                                    data-noSoal="{{ $no }}" class="answer-radio"
                                                                    @if ($soal->jawaban == substr($soal->detailujian->pg_3, 0, 1)) checked @endif />
                                                                <label
                                                            ...
                                                            <li class="answer-number">
                                                                <input type="radio" data-alternatetype="radio"
                                                                    name="{{ $soal->detailujian->id }}"
                                                                    value="{{ substr($soal->detailujian->pg_4, 0, 1) }}"
                                                                    id="soal{{ $no }}-{{ substr($soal->detailujian->pg_4, 0, 1) }}"
                                                                    data-pg_siswa="{{ $soal->id }}"
                                                                    data-noSoal="{{ $no }}" class="answer-radio"
                                                                    @if ($soal->jawaban == substr($soal->detailujian->pg_4, 0, 1)) checked @endif />
                                                                <label
                                                            ...
                                                            <li class="answer-number">
                                                                <input type="radio" data-alternatetype="radio"
                                                                    name="{{ $soal->detailujian->id }}"
                                                                    value="{{ substr($soal->detailujian->pg_5, 0, 1) }}"
                                                                    id="soal{{ $no }}-{{ substr($soal->detailujian->pg_5, 0, 1) }}"
                                                                    data-pg_siswa="{{ $soal->id }}"
                                                                    data-noSoal="{{ $no }}"
                                                                    class="answer-radio"
                                                                    @if ($soal->jawaban == substr($soal->detailujian->pg_5, 0, 1)) checked @endif />
                                                                <label
                                    ...
                                    <div class="col-sm-3 text-center mt-3 ragu-container">
                                        ...
                                        @foreach ($pg_siswa as $soal)
                                            <div class="question {{ $hidden }} question-{{ $no }} ragus ragus-{{ $no }}"
                                                data-question="{{ $no }}">
                                                <button type="button" class="ragu hapus-jawaban btn btn-danger"
                                                    id="ragu{{ $soal->detailujian->id }}"
                                                    data-id_pg="{{ $soal->id }}"
                                                    data-mark_name="{{ $soal->detailujian->id }}"
                                                    data-question="{{ $no }}" onclick="hapusjawaban()">Hapus
                                                    Jawaban


                                                </button>
                                                <label for="ragu{{ $soal->detailujian->id }}"
                                                    class="mb-0 text-white"></label>
                                            </div>

                                            {{-- <button clas>testes</button> --}}
                                            @php
                                                $no++;
                                                $hidden = 'hidden';
                                            @endphp
                            ...
                            <div class="widget-content">
                                ...
                                @foreach ($pg_siswa as $soal)
                                    <div class="question-response-rows d-inline" data-question="{{ $no }}">
                                        <button
                                            class="button-soal btn @if ($soal->ragu == null && $soal->jawaban == null) btn-white @endif shadow mt-2 question-response-rows-value @if ($soal->jawaban !== null) btn-info @endif @if ($soal->ragu !== null) btn-warning @endif"
                                    ...
                                    <script>
                                        // console.log("asdasd", document.getElementById("soalId{{ $soal->detailujian->id }}"))
                                        // const changeButtonColorSoal = () => {
                                        //     const btn = document.getElementById("soalId{{ $soal->detailujian->id }}")
                                ...
                                {{-- <script>
                                    const buttonSoal = document.querySelector(".button-soal")
                                    console.log(buttonSoal)
                                    buttonSoal.classList.remove("btn-")
                                    document.querySelector(".hapus-jawaban").addEventListener('click', function() {

                                        document.querySelectorAll('.answer-radio').forEach(function(radio) {
                                            console.log("value radio", radio.checked);
                                            radio.checked = false
                                ...
                                <script>
                                    // const buttonSoal = document.querySelectorAll(".button-soal")
                                    // console.log(buttonSoal)

                                    // const buttons = document.querySelectorAll(".button-soal");
                                    ...
                                    //         const btnSoal = document.querySelectorAll(".button-soal")
                                    //         console.log(btnSoal[questionNumber - 1])
                                    //         btnSoal[questionNumber - 1].classList.remove("btn-info")
                                    //         btnSoal[questionNumber - 1].classList.add("btn-white")
                                    ...
                                    // buttons.forEach(button => {
                                    //     button.addEventListener('click', hapusjawaban);
                                    // });
                                    // const buttonSoal = document.querySelector(".button-soal")
                                    // console.log(buttonSoal)
                                    // buttonSoal.classList.remove("btn-")
                                            ...
                                            <div class="widget p-3 mt-3">
                                                ...
                                                <div class="widget-content mt-3">
                                                    ...
                                                    <div class="mt-2" style="font-weight: bold;">
                                                        ...
                                                        @endif
                                                        @if ($soal->benar == '1')
                                                            <span class="">Yang kamu jawab</span>
                                                        @endif
                                                        @if ($soal->benar == '0')
                                                            <span class="">Yang kamu jawab</span>
                                                        @endif
    ...
    <script src="" defer>
        // const hapusButton = document.querySelectorAll(".hapus-jawaban")[0]
        // console.log(hapusButton)
        // hapusButton.addEventListener("click", function() {
        //     console.log("lsakdajlkj")
        //     alert("kasjd")
        // })
        ...
        document.addEventListener("DOMContentLoaded", function() {
            // Tangkap semua elemen dengan kelas .hapus-jawaban
            const hapusJawabanButtons = document.querySelectorAll(".hapus-jawaban");

            console.log(hapusJawabanButtons)

            // Loop melalui setiap tombol
            hapusJawabanButtons.forEach(function(button) {
                // Tambahkan event listener untuk setiap tombol
                button.addEventListener('click', function() {
                    // Tangkap semua elemen radio dengan kelas .answer-radio
                    document.querySelectorAll('.answer-radio').forEach(function(radio) {
                        // Set setiap radio menjadi tidak dicentang dan nilai radio menjadi null
                        radio.checked = false;
                        radio.value = null;
                    });
                });
