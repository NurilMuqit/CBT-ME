                                ...
                                <form action="{{ url('/siswa/tugas/' . $tugas_siswa->kode) }}" method="POST"
                                    ...
                                    <div class="row">
                                        @foreach ($file_siswa as $file)
                                            ...
                                            @endphp
                                            <div class="col-lg-6 mt-2 hapus-file" data-src="{{ $file->nama }}"
                                                style="cursor: pointer;">
                                                <ul class="list-group list-group-media">
                                                    <li class="list-group-item list-group-item-action"
                                                        style="padding: 0px 10px;">
                                                        <div class="media lihat-file position-relative"
                                    ...
                                    <div class="custom-file-container mt-3" data-upload-id="fileSiswa">
                                        ...
                                        <label class="custom-file-container__custom-file file_materi">
                                            <input type="file"
                                                class="custom-file-container__custom-file__custom-file-input" name="files[]"
                                                multiple>
                                    ...
                                    <a href="{{ url('/siswa/tugas/' . $tugas_siswa->kode) }}"
                                        class="btn btn-danger btn-sm mt-3"><span data-feather="arrow-left-circle"></span>
                                        Kembali</a>
                                    <button type="submit" class="btn btn-primary btn-sm mt-3"><span
                    ...
                    <div class="widget shadow">
                        <div class="widget-content-area">
                            ...
                            <table cellpadding="2">
                                ...
                                <tr>
                                    <th>Nilai</th>
                                    <th> : {!! $tugas_siswa->nilai === null
                                        ? 'Belum dinilai'
                                        : '<span class="text-primary">' . $tugas_siswa->nilai . '/100 Point </span>' !!}</th>
                                </tr>
                            </table>
                            <table class="mt-2">
                                <tr>
