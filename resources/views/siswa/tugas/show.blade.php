...
@section('content')
                ...
                <div class="col-lg-12 layout-spacing">
                    <div class="widget shadow">
                        <div class="widget-content-area">
                                        ...
                                        <div class="col-lg-4 mt-2">
                                            <ul class="list-group list-group-media">
                                                <li class="list-group-item list-group-item-action"
                                                    ...
                                                    <div class="media lihat-file" data-toggle="modal"
                                                        data-target="#fileModal" data-source="{{ $file->nama }}"
                                                        data-extension="{{ $ekstensi }}"
                                                        style="cursor: pointer; margin-top: 5px; margin-bottom: 5px;">
                                                        <div class="mr-1">
                                                            @if ($ekstensi == 'mp4' || $ekstensi == 'mkv' || $ekstensi == 'ogg')
                                                                <img alt="avatar"
                                                                    src="{{ url('/assets/img/docs/mp4.svg') }}"
                                                                    class="img-fluid">
                                                            @elseif ($ekstensi == 'mp3' || $ekstensi == 'mpeg' || $ekstensi == 'm4a')
                                                                <img alt="avatar"
                                                                    src="{{ url('/assets/img/docs/mp3.svg') }}"
                                                                    class="img-fluid">
                                                            @elseif ($ekstensi == 'jpg' || $ekstensi == 'png' || $ekstensi == 'jpeg' || $ekstensi == 'svg' || $ekstensi == 'gif')
                                                                <img alt="avatar"
                                                                    src="{{ asset('assets/files/' . $file->nama) }}"
                                                                    class="img-fluid">
                                                            @elseif ($ekstensi == 'xls' || $ekstensi == 'xlsx' || $ekstensi == 'csv')
                                                                <img alt="avatar"
                                                                    src="{{ url('/assets/img/docs/xls.svg') }}"
                                                                    class="img-fluid">
                                                            @elseif ($ekstensi == 'doc' || $ekstensi == 'docx')
                                                                <img alt="avatar"
                                                                    src="{{ url('/assets/img/docs/doc.svg') }}"
                                                                    class="img-fluid">
                                                            @elseif ($ekstensi == 'pdf')
                                                                <img alt="avatar"
                                                                    src="{{ url('/assets/img/docs/pdf.svg') }}"
                                                                    class="img-fluid">
                                                            @elseif ($ekstensi == 'ppt' || $ekstensi == 'pptx')
                                                                <img alt="avatar"
                                                                    src="{{ url('/assets/img/docs/ppt.svg') }}"
                                                                    class="img-fluid">
                                                            @else
                                                                <img alt="avatar"
                                                                    src="{{ url('/assets/img/docs/file.png') }}"
                                                                    class="img-fluid">
                                                            @endif
                            ...
                            {{-- <div id="toggleAccordion">
                                <div class="card">
                                    ...
                                    <div class="card-footer" style="background: #fff;">
                                        ...
                                        <textarea class="form-control komentar" name="chat" placeholder="Tulis komentar / chat"
                                        ...
                                        @if ($tugas_siswa != null)
                                            ...
                                            @if ($tugas_siswa->date_send === null)
                                                <p>Ujian Essay Belum Dikumpulkan. Segera dikumpulkan sebelum
                                                    <?= $tugas->due_date ?></p>
                                                <a href="{{ url('/siswa/tugas/kerjakan/' . $tugas_siswa->id) }}"
                                                    class="btn btn-primary btn-kerjakan">Kerjakan</a>
                                            @else
                                                <table cellpadding="5">
                                                    <tr>
                                                        <th>Status</th>
                                                        <td> : {!! $tugas_siswa->is_telat == 1
                                                            ? '<span class="badge badge-danger">Terlambat</span>'
                                                            : '<span class="badge badge-success">Sukses</span>' !!}</td>
                                                    </tr>
                                                    <tr>
                                                        <th>Nilai</th>
                                                        <td> : {!! $tugas_siswa->nilai === null
                                                            ? 'Belum dinilai'
                                                            : '<span class="text-primary">' . $tugas_siswa->nilai . '/100 Point </span>' !!}</td>
                                                    </tr>
                                                </table>
                                                <table class="mt-2">
                                                    <tr>
                            ...
                            <a href="{{ url('/siswa/tugas') }}" class="btn btn-danger btn-sm mt-3"><span
    ...
    @if ($tugas_siswa != null)
        ...
        <div class="modal fade" id="kerjakan_tugas" tabindex="-1" role="dialog" aria-labelledby="kerjakan_tugasLabel"
            aria-hidden="true">
        ...
        <!-- Modal lihat Tugas -->
        <div class="modal fade" id="lihat_tugas" tabindex="-1" role="dialog" aria-labelledby="lihat_tugasLabel"
            aria-hidden="true">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                                    ...
                                    <div class="col-lg-5 mt-2">
                                        <ul class="list-group list-group-media">
                                            <li class="list-group-item list-group-item-action" style="padding: 0px 10px;">
                                                <div class="media lihat-file" data-toggle="modal"
                                                    data-target="#fileModal" data-source="{{ $fs->nama }}"
                                                    data-extension="{{ $ekstensi }}"
                                                    style="cursor: pointer; margin-top: 5px; margin-bottom: 5px;">
                                                    <div class="mr-1">
                                                        @if ($ekstensi == 'mp4' || $ekstensi == 'mkv' || $ekstensi == 'ogg')
                                                        ...
                                                        @elseif ($ekstensi == 'jpg' || $ekstensi == 'png' || $ekstensi == 'jpeg' || $ekstensi == 'svg' || $ekstensi == 'gif')
                                                            <img alt="avatar"
                                                                src="{{ asset('assets/files/' . $fs->nama) }}"
                                                                class="img-fluid">
                                                        @elseif ($ekstensi == 'xls' || $ekstensi == 'xlsx' || $ekstensi == 'csv')
                                                            <img alt="avatar"
                                                                src="{{ url('/assets/img/docs/xls.svg') }}"
    ...
    <script>
        $('.lihat-file').click(function() {
            ...
            `;
                ...
                var html = `
                <object data="{{ asset('assets/files') }}/` + source +
                    `" type="application/pdf" width="100%" height="500px">
                    <p>
                        Browser kamu tidak support untuk menampilan pdf, tapi kamu bisa mendownloadnya <a href="{{ url('/summernote/unduh') }}/` +
                    source + `" class="text-primary">di sini</a>
                    </p>
                </object>
            `;
        ...
        $("#chat_tugas").click(function() {
            var a = $("textarea[name=chat]").val(),
                e = $("input[name=kode]").val();
            $.ajax({
                headers: {
                ...
                async: !0,
                url: "{{ url('/chat/simpan') }}/{{ $tugas->kode }}",
                success: function(a) {
                    $("textarea[name=chat]").val("")
                }
            })
        }), setInterval(() => {
            var a = $("input[name=kode]").val();
            $.ajax({
                headers: {
                    "X-CSRF-TOKEN": "{{ csrf_token() }}"
                },
