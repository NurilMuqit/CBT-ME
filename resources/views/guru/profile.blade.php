                    ...
                    <div class="user-profile layout-spacing">
                        <div class="widget-content widget-content-area">
                            ...
                            <div class="text-center user-info">
                                <img src="{{ asset('assets/user-profile/' . $guru->avatar) }}" class="img-user"
                ...
                <div class="col-xl-8 col-lg-6 col-md-7 col-sm-12 layout-top-spacing">
                    ...
                    <div class="skills layout-spacing ">
                        <div class="widget-content widget-content-area">
                            ...
                            <form action="{{ url('/guru/edit_profile/' . $guru->id) }}" method="post"
                                enctype="multipart/form-data">
                                @csrf
                                <div class="form-group">
                                    <label for="">Nama</label>
                                    <input type="text" name="nama_guru" id="nama_guru"
                                        value="{{ old('nama_guru', $guru->nama_guru) }}" class="form-control" required>
                                </div>
                                <div class="form-group">
