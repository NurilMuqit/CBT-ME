                                    ...
                                    <div class="row mt-2">
                                        <div class="col-lg-4">
                                            <div class="form-group">
                                                ...
                                                <textarea name="pg_1[]" cols="30" rows="2" class="summernote" placeholder="Opsi A" autocomplete="off" required></textarea>
                                            </div>
                                        </div>
                                        <div class="col-lg-4">
                                            <div class="form-group">
                                                <label for="">Pilihan B</label>
                                                <textarea name="pg_2[]" cols="30" rows="2" class="summernote" placeholder="Opsi B" autocomplete="off" required></textarea>
                                            </div>
                                        </div>
                                        <div class="col-lg-4">
                                            <div class="form-group">
                                                <label for="">Pilihan C</label>
                                                <textarea name="pg_3[]" cols="30" rows="2" class="summernote" placeholder="Opsi C" autocomplete="off" required></textarea>
                                            </div>
                                        </div>
                                        <div class="col-lg-4">
                                            <div class="form-group">
                                                <label for="">Pilihan D</label>
                                                <textarea name="pg_4[]" cols="30" rows="2" class="summernote" placeholder="Opsi D" autocomplete="off" required></textarea>
                                            </div>
                                        </div>
                                        <div class="col-lg-4">
                                            <div class="form-group">
                                                <label for="">Pilihan E</label>
                                                <textarea name="pg_5[]" cols="30" rows="2" class="summernote" placeholder="Opsi E" autocomplete="off" required></textarea>
                                            </div>
                                        </div>
                                        <div class="col-lg-4">
                                            <div class="form-group">
