...
@section('content')
    ...
    <div id="content" class="main-content">
        <div class="layout-px-spacing">
                                    ...
                                    {{-- <div class="card-header" id="...">
                                        <section class="mb-0 mt-0">
                                            <div role="menu" class="collapsed" data-toggle="collapse"
                                                ...
                                                aria-controls="defaultAccordionOne" style="cursor: pointer">
                    ...
                    <div id="tugasAccordion" class="shadow">
                        <div class="card">
                            <div class="card-header bg-white" id="...">
                                <section class="mb-0 mt-0">
                                    <div role="menu" class="" data-toggle="collapse" data-target="#TugasSiswa"
                                        aria-expanded="true" aria-controls="TugasSiswa" style="cursor: pointer">
                                                ...
                                                @foreach ($tugas_siswa as $ts)
                                                    ...
                                                    @if ($ts->date_send !== null)
                                                        <tr>
                                                            ...
                                                            <td>{{ $ts->nilai === null ? 'belum Dinilai' : $ts->nilai }}
                                                            </td>
                                                            <td>
                                                                <a href="{{ url('/guru/tugas_siswa/' . $ts->id) }}"
            ...
            <a href="{{ url('/guru/tugas') }}" class="btn btn-danger btn-sm mt-3"><span
